...
Config.Helicopter = "buzzard2" -- Helicopter model that players with the ambulance job can use
Config.BillCost = 300 -- Price that players are charged for using the hospital check-in system
Config.DeathTime = 70 -- How long the timer is for players to bleed out completely and respawn at the hospital
...
Config.Locations = { -- Edit the various interaction points for players or create new ones
    ["checking"] = {
	    [1] = vector3(-1088.02, 1756.54, 23.37),
	    --[2] = vector3(-254.54, 6331.78, 32.43), -- paleto
    },
    ["duty"] = {
        [1] = vector3(69.92, -72.08, 4.93),   --NY Union DR Hospital
        [2] = vector3(-1085.45, 1750.68, 23.37),
    },
    ["vehicle"] = {
        [1] = vector4(43.93, -72.9, 4.79, 85.68),
        [2] = vector4(-1063.52, 1749.07, 22.37, 308.77)
    },
    ["helicopter"] = {
        [1] = vector4(65.64, -243.47, 185.57, 77.87),
        [2] = vector4(-475.43, 5988.353, 31.716, 31.34),
    },
    ["armory"] = {
        [1] = vector3(309.93, -602.94, 43.29),
        [2] = vector3(-1083.41, 1752.31, 23.37),
    },
    ["roof"] = {
        [1] = vector3(88.32, -63.28, 4.94),
    },
    ["main"] = {
        [1] = vector3(85.0, -233.24, 183.65),
    },
    ["stash"] = {
        [1] = vector3(70.15, -77.79, 4.93),
    },
    ["beds"] = {
        [1] = {coords = vector4(-1113.9, 1771.18, 24.29, 222.77), taken = false, model = 1631638868},
        [2] = {coords = vector4(-1111.31, 1773.1, 24.29, 213.61), taken = false, model = 1631638868},
        [3] = {coords = vector4(-1108.46, 1775.3, 24.29, 218.52), taken = false, model = 1631638868},
        [4] = {coords = vector4(-1105.61, 1777.81, 24.29, 229.21), taken = false, model = 1631638868},
       -- [5] = {coords = vector4(314.47, -584.2, 42.84, 334.65), taken = false, model = 2117668672},
    ...
    ["stations"] = {
        [1] = {label = Lang:t('info.pb_hospital'), coords = vector4(52.48, -64.43, 4.94, 87.19)},
        [2] = {label = "Central Hospital", coords = vector4(-1084.27, 1767.23, 23.37, 306.93)}
    }
}
...
Config.AuthorizedVehicles = { -- Vehicles players can use based on their ambulance job grade level
	-- Grade 0
	[0] = {
		["dodgeEMS"] = "EMS Charger",
        ["fdlcamb"] = "EMS Ambulance",
        ["lcamb"] = "EMS Ambulance 2",
        ["fdlcamb3"] = "EMS Ambulance 3",
	},
	-- Grade 1
	[1] = {
		["dodgeEMS"] = "EMS Charger",
